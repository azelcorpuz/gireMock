...
package io.giremock.protoc.generator.mock;

import com.google.common.base.Strings;
import com.google.common.html.HtmlEscapers;
import com.google.protobuf.DescriptorProtos;
import com.google.protobuf.compiler.PluginProtos;
import io.giremock.protoc.generator.Generator;
import io.giremock.protoc.generator.GeneratorException;
import io.giremock.protoc.generator.ProtoTypeMap;
import io.giremock.protoc.generator.ProtocPlugin;
...
public class MockGenerator extends Generator {
        ...
        locations.stream()
                ...
                .forEach(location -> {
                    ...
                    if (!methodProto.getClientStreaming() && !methodProto.getServerStreaming()) {
                        ...
                        ctxMethod.content = getMethodContent(methodProto.getClientStreaming(), methodProto.getServerStreaming(), ctxMethod.inputType);
    ...
    private String getMethodContent(boolean clientStreaming,  boolean serverStreaming, String inputType){
        ...
        if (serverStreaming){
            builder.append(codeIndent).append("       jsonResponses.addAll(new GrpcApiData(\"$service_name$\", \"$lower_method_name$\").getAll(jsonRequest));\n");
        } else {
            builder.append(codeIndent).append("       jsonResponses.add(new GrpcApiData(\"$service_name$\", \"$lower_method_name$\").get(jsonRequest));\n");
        }
